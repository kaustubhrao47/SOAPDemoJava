...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.calculator.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8080/SOAPDemo/services/Calculator";
    ...
    public com.calculator.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.calculator.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.calculator.CalculatorSoapBindingStub _stub = new com.calculator.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.calculator.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.calculator.CalculatorSoapBindingStub _stub = new com.calculator.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://calculator.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://calculator.com", "Calculator"));
        }
